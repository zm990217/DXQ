...
void PVPWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PVPWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PVPWindow::signalBack)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PVPWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PVPWindow.data,
